...
var givenNumber = 28;
var daysInWeek = 7;
var daysToWeek = givenNumber / daysInWeek;
...
var price = 1000;
if (price >= 100) {
    var discount = price * 10 / 100; //discount find krny ky liye price * jitna dicount hy
    ...
    var final_Price2 = price - discount2;
...
var year = 1600; // leap year 4 saal bad ata usually 1 year mei 365 days hoty
