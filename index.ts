...
even numbers*/
var evenNum: number[] = [1,3,4,6,8,9,2]
...
var evenOdd:number[] = [7,12,15,16,17,5,18]
...
function calculateArea(radius:number){
    var pi:number = 3.1416
    var findArea:number = pi * Math.pow(radius,2)
    return findArea
}
var areaOfCircle:number = calculateArea(5)
...
var arrayOfGrades:number[] = [56,45,89,35,62,75,49]
for(let i:number = arrayOfGrades.length-1; i>= 0;  i--){
